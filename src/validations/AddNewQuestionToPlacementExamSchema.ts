...
const AddNewQuestionToPlacementExamSchema = z.object({
    // =================================
    questionText: z
        .string()
...
type AddNewQuestionToPlacementExamType = z.infer<typeof AddNewQuestionToPlacementExamSchema>;

export { AddNewQuestionToPlacementExamSchema, type AddNewQuestionToPlacementExamType }